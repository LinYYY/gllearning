...
object GLTexture {
     ...
     * @return 纹理id
     */
    fun loadTexture(ctx: Context, @DrawableRes resId: Int): Int {
     ...
     * @param ctx        上下文
     * @param resId      资源id
     * @param repeatType 重复方式 [RepeatType]
     * @return 纹理id
     */
    fun loadTexture(ctx: Context, resId: Int, repeatType: RepeatType?): Int {
        val bitmap = BitmapFactory.decodeResource(ctx.getResources(), resId)
